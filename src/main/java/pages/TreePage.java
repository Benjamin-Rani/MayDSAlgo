...
public class TreePage {
	...
	//@FindBy(xpath = "//a[@href='binary-trees'][contains(text(),'Binary Trees')]")WebElement  Binary_Trees;
		
		/*
		 @FindBy(xpath = "//a[@href='terminologies'][contains(text(),'Terminologies')]")WebElement TerminologiesOfTree;
		 @FindBy(xpath = "//div[@class='row row-cols-1 row-cols-md-3 g-4']/div[6]//a") WebElement gtree;
		 @FindBy(xpath = "//a[contains(text(),'Overview of Trees')]") WebElement OverviewofTree;
		//@FindBy(xpath = "/a[contains(text(),'Types of Trees')]") WebElement typesoftree;
		//@FindBy(xpath = "//div[@id='content']//li[4]") WebElement treeTraversals;
		@FindBy(xpath = "//a[contains(text(),'Traversals-Illustration')]") WebElement illustration;
		//@FindBy(xpath = "//*[@id='content']/li[6]/a") WebElement binaryTree;
		 * 
		 */
